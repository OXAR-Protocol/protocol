...
export default function YieldPage() {
  ...
  return (
    ...
    <div className="max-w-[900px] mx-auto pt-8 pb-32 px-4">
      ...
      {/* Top movers — a discovery strip across stocks + gold (24h). It belongs where
          the things it advertises are bought, not on the page about your own money. */}
      <TopMoversCarousel />
