  ...
  return (
    <DocPage label="for investors" title="oxar">
      ...
      <section>
        ...
        <p>
          <strong>Now (May 2026):</strong> Smart contracts live on Solana Devnet. Personal vault flow (initialize → deposit → withdraw → crank NAV) verified end-to-end. Program ID <code>8RCVjQJh...nCBQwJ</code>. Group vault contracts under construction.
        </p>
        <p className="mt-3">
