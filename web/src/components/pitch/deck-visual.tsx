...
/** The short deck — twelve slides, one image and one line each. This is the version to
 *  present *over*: it carries the arc, you carry the detail. `deck.tsx` is the long one,
 *  the seventeen slides that read on their own with nobody talking. Same visual system,
 *  same facts — this one just says less. */
    ...
    <>
      ...
      <section className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-black px-6 text-center">
        ...
        <p className={`${SUB} mx-auto mt-6 max-w-lg text-[clamp(15px,1.5vw,19px)]`}>
          daniel lohachov — product and engineering. anna tarapatska — operations, legal
          and partnerships. building from ukraine, bootstrapped.
        </p>
