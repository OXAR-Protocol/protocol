...
export const uk: Partial<Record<TranslationKey, string>> = {
  ...
  "intro.1": "твої гроші не мають лежати без діла. тут вони сплять там, де платять.",
  "intro.2": "поклади долари й заробляй на них — без блокування, забереш будь-коли.",
  "intro.3": "або тримай акції та золото, звідки б ти не був.",
  "intro.4": "вони не покидають твій гаманець. ми не можемо їх забрати, заморозити чи втратити.",
  "intro.next": "далі",
