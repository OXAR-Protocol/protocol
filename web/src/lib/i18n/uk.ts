...
export const uk: Partial<Record<TranslationKey, string>> = {
  ...
  "profile.positionsLabel": "з чого це складається",
  "profile.allPositions": "усі позиції: {n}",
  ...
  "convert.hint": "Оберіть, що перетворити на долари, потім скажіть скільки.",
  "convert.available": "доступно {value} у {sym}",
  "convert.action": "перетворити {sym} на долари",
  "convert.positionsElsewhere": "Усе куплене — дохідне джерело, золото, акція — продається на своїй сторінці, де видно і скільки воно варте, і скільки коштує вийти.",
  "convert.positionsLink": "ваші позиції",
  "convert.nothing": "Тут нічого міняти — усе, що ви маєте, вже долари.",
