...
export const uk: Partial<Record<TranslationKey, string>> = {
  ...
  "home.napping1": "твої гроші просто лежать.",
  "home.napping2": "а могли б спати там, де платять.",
  "home.empty.body":
    "поклади долари в джерело - і вони почнуть заробляти того ж дня. забереш коли завгодно, вони весь час твої.",
  ...
  "yield.subtitle":
    "Відкрий джерело, щоб побачити, скільки воно платить і як працює. Те, що ти вкладаєш, іде напряму туди й лишається твоїм, а забрати можна будь-коли.",
  "yield.clear": "скинути",
  ...
  "yield.metalsTitle": "Сировина · метали",
  ...
  "deposit.short": "не вистачає {value} — поповнити",
  ...
  "bulk.hint": "обери кілька - купуй або продавай разом",
  "bulk.pick": "у кошик",
  ...
  "alloc.chooseAgain": "обрати інакше",
  "alloc.stay": "лишитись",
  "alloc.leave": "вийти",
  "alloc.otherCoins": "ще {usd} в інших монетах - витратиш їх, і вони спершу стануть доларами.",
  "alloc.willConvert": "{usd} з інших твоїх монет спершу стануть доларами за ринковим курсом. Один зайвий крок, а далі покупка.",
  "alloc.converting": "перетворюємо монети на долари…",
  "pay.with": "платимо з",
  "pay.readyNow": "готові до витрати",
  "pay.viaSwap": "спершу стане доларами",
  "pay.viaSale": "спершу продамо за долари",
  "pay.selling": "продаємо за долари…",
  "pay.noteSwap": "{sym} спершу обміняємо на долари - за тією ціною, яку ринок дає в цю мить.",
  "pay.noteSale": "{sym} спершу продамо за долари - це справжній продаж, за ціною ринку в цю мить. Обмін трохи коштує, як і будь-який інший.",
  "pool.sameRate": "Зараз обидва платять приблизно однаково, тож ставка тут нічого не вирішує.",
  "pool.rateAside": "Ставка змінюється. Ці два відрізняються не лише нею.",
  "pool.inPool": "{usd} позичено тут",
  "pool.sizeMeans": "Більший пул витримує велике зняття без стрибка ставки, а на руках у тебе лишається той долар, який ти обрав.",
  "rail.max": "все",
  ...
  "rail.exitCostNowFee":
    "вийти прямо зараз коштувало б приблизно {pct}% — майже все це ціна ринку, плюс наші {fee}%",
  ...
  "sell.detail.impact": "вплив на ціну",
  ...
  "tour.catalog.body": "усі місця, де можуть спати твої гроші — заощадження, акції, метали.",
  ...
  "money.withdraw.title": "Вивести гроші",
  "money.withdraw.body": "На власний гаманець або на картку",
  "money.history": "Усі ваші рухи — у портфелі, в розділі історії.",
  "withdraw.label": "виведення",
  "withdraw.title": "Куди?",
  "withdraw.wallet.title": "На криптогаманець",
  "withdraw.wallet.body": "Будь-яка ваша адреса — у Solana чи іншій мережі",
  "withdraw.card.title": "На картку",
  "withdraw.card.body": "Через ліцензованого провайдера, у вашій валюті",
  ...
  "send.review.to": "куди",
  "send.review.network": "мережа",
  "send.review.warnOwn": "Надсилайте лише на адресу, якою володієте самі.",
  "send.review.warnSolana": "Це {sym} у мережі Solana — переконайтеся, що гаманець її приймає.",
  ...
  "fund.title": "Поповнити",
  "fund.free": "вільні кошти",
  "fund.back": "назад",
  "fund.timing": "крипта приходить приблизно за хвилину, картка — за 5–15.",
  "fund.crypto.title": "З криптогаманця",
  ...
  "fund.network.hint": "Звідки надходять гроші?",
  "fund.network.solana": "З гаманця Solana",
  "fund.network.direct": "Одразу у ваш гаманець, без посередників",
  "fund.network.elsewhere": "З іншої мережі або з біржі",
  "fund.network.bridged": "Надішліть, що маєте і звідки маєте — сюди прийдуть долари",
  "fund.network.disclosure": "Обмін виконує інший провайдер. Курс і час зарахування — його, не наші.",
  ...
  "fund.convert.title": "Перетворити монети на долари",
  "fund.convert.body": "SOL, USDT чи будь-що інше — обміняємо за ринковим курсом",
  "convert.hint": "Оберіть, що перетворити на долари — монету чи щось куплене — і скажіть скільки.",
  "convert.position": "позиція",
  "convert.available": "доступно {value} у {sym}",
  "convert.action": "перетворити {sym} на долари",
  "convert.nothing": "Немає чого перетворювати — усе, що ви маєте, вже долари.",
  "convert.rate": "Курс — ринковий на момент натискання, не наш.",
  "fund.exchange.title": "З біржі",
  "fund.exchange.body": "Виведіть з Binance, Bybit, Revolut та інших",
  "fund.exchange.hint":
    "Виведіть USDC на цю адресу й оберіть мережу SOLANA. З будь-якою іншою мережею гроші не дійдуть.",
  ...
  "send.step.network": "Яка мережа?",
  "send.step.address": "Куди?",
  ...
  "send.address.on": "у мережі {chain}",
  "send.address.hint": "Перевірте ще раз. Надіслану транзакцію не відкличе ніхто, зокрема ми.",
  "send.token.selected": "обрано",
  ...
  "send.sentTo": "на {address} у мережі {chain}",
