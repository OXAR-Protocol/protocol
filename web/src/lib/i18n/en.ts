...
export const en = {
  ...
  "convert.hint": "Pick what to turn into dollars, then say how much.",
  "convert.available": "{value} of {sym} available",
  "convert.action": "turn {sym} into dollars",
  "convert.positionsElsewhere": "Anything you bought — a yield source, gold, a share — is sold on its own page, where what it's worth and what leaving costs are both on screen.",
  "convert.positionsLink": "your positions",
  "convert.nothing": "Nothing here to convert — everything you hold is already dollars.",
