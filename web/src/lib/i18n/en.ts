...
export const en = {
  ...
  "intro.1": "your money shouldn't sit still. here it sleeps somewhere that pays.",
  "intro.2": "park dollars and earn on them — no lock-up, take them back whenever.",
  "intro.3": "or hold stocks and gold, from wherever you happen to live.",
  "intro.4": "it never leaves your wallet. we can't move it, freeze it, or lose it.",
  "intro.next": "next",
  "intro.skip": "skip",
