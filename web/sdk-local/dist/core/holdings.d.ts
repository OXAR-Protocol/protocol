...
export declare function valueHoldings(balances: Balances, prices: Prices): Valuation;
...
export declare function totalAum(valuations: readonly Valuation[]): AumTotals;
