...
exports.PLATFORM_FEE_BPS = void 0;
exports.platformFeeUsd = platformFeeUsd;
/** Basis points we take when the fee is on. 25 = 0.25%. */
exports.PLATFORM_FEE_BPS = 25;
/** Fee in dollars for a swap of `usdAmount`, at the current rate. */
function platformFeeUsd(usdAmount, bps = exports.PLATFORM_FEE_BPS) {
    return usdAmount > 0 ? (usdAmount * bps) / 10000 : 0;
}
