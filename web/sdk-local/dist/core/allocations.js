...
exports.rescaleAllocations = rescaleAllocations;
 ...
 */
function rescaleAllocations(amounts, availableUsd) {
    ...
    if (availableUsd <= 0)
        return {};
    if (availableUsd >= requested)
        return Object.fromEntries(entries);
    const factor = availableUsd / requested;
    return Object.fromEntries(entries
        .map(([id, v]) => [id, (0, format_1.floorToCents)(v * factor)])
        .filter(([, v]) => v > 0));
}
