          ...
          <>
            ...
            >
              <svg viewBox="0 0 104 104" className="w-full h-full drop-shadow-[0_6px_14px_rgba(168,34,43,0.55)]">
                ...
                <circle cx="52" cy="52" r="42" fill="none" stroke="#F5D5A1" strokeWidth="0.6" opacity="0.7" />
                <circle cx="52" cy="52" r="36" fill="none" stroke="#F5D5A1" strokeWidth="0.4" opacity="0.5" />
                <text
                  x="52"
                  y="40"
                  textAnchor="middle"
                ...
                <path
                  d="M 38 50 L 52 42 L 66 50 L 52 58 Z"
                  fill="none"
                  stroke="#F5D5A1"
                  strokeWidth="0.7"
                  opacity="0.85"
                />
                <circle cx="52" cy="50" r="3" fill="#F5D5A1" opacity="0.85" />
                <text
                  x="52"
                  y="72"
                  textAnchor="middle"
