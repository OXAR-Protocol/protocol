...
def build() -> Deck:
    ...
    d.rows(
        ...
        [
            ...
            ("q4 2026", "ukrainian government bonds, through a licensed broker. euro yield, and assets from issuers jupiter cannot route today.", False),
        ...
        "is the one an investor stops on — the only item here a competitor cannot buy "
        "with an integration. Expect the question 'which broker'.",
    )
